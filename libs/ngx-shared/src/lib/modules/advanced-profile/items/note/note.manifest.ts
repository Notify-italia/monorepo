...
import { NotePlayerComponent } from './note.player.component';

const manifest: INotifyAdvancedProfileManifest<INotifyAPNoteItem> = {
  type: EnumNotifyAdvancedProfileItems.Note,
  localizedName: 'Progetto',
  filledIcon: [
  ...
  formComponent: NoteFormComponent,
  playerComponent: NotePlayerComponent,
  definitions: {
