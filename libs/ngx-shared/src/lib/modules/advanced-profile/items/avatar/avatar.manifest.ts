...
const manifest: INotifyAdvancedProfileManifest<INotifyAPAvatarItem> = {
  ...
  formComponent: AvatarFormComponent,
  playerComponent: AvatarPlayerComponent,
  definitions: {
