...
import { FeedbackPlayerComponent } from './feedback.player.component';

const manifest: INotifyAdvancedProfileManifest<INotifyAPFeedbackItem> = {
  type: EnumNotifyAdvancedProfileItems.Feedback,
  localizedName: 'Feedback',
  formComponent: FeedbackFormComponent,
  playerComponent: FeedbackPlayerComponent,
  filledIcon: [
