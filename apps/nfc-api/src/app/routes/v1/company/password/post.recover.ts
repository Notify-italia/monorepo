...
const passwordResetLinkEmailTemplate = (
  ...
  <p><a href="https://aziende.notifyapp.it/password/reset?t=${token}">Reset Password</a></p>
  
  <p>Se non hai richiesto il reset della password o se hai ricevuto questa email per errore, ignora semplicemente questo messaggio.</p>
