    ...
    async (req, res) => {
      ...
      const response = await createGPT({
        ...
        messages: [
          {
            role: 'system',
            content: `Analizza l'immagine fornita per estrarre i dati di un biglietto da visita. Se l'immagine non contiene un biglietto da visita valido, restituisci {\"invalid\": true}. Se l'immagine contiene un biglietto da visita valido, estrai i seguenti campi e restituiscili in formato JSON, inserendo una stringa vuota per i campi mancanti: {\"name\": \"<name>\", \"surname\": \"<surname>\", \"company\": \"<company>\", \"role\": \"<role>\", \"color\": \"<color>\", \"address\": \"<address>\", \"phoneNumbers\": [\"<phone1>\", \"<phone2>\"], \"emails\": [\"<email1>\", \"<email2>\"], \"socials\": [{\"name\": \"<name>\", \"url\": \"<url>\"}]}. Inoltre, se trovi un sito web, inseriscilo in \"socials\" con tipo \"website\". Includi dati a penna se presenti. Ignora eventuali partite IVA. Inserisci in 'color' il colore dominante del biglietto in hex (SOLO BIGLIETTO, NO SFONDO). Restituisci solo il JSON risultante, senza altri testi.`,
          },
          {
            role: 'user',
            content: [
